...
const SearchBar = ({ label, placeholder, data, setFormData }) => {
  ...
  const setWord = (word) => {
    setFilteredData([]);
    setWordEntered(word);
    setFormData({ ...FormData, crypto: word });
  };
  return (
    <>
      <div className="search relative">
        ...
        {filteredData.length != 0 && (
          <div
            className={
              "dataresults z-10 no-scrollbar overflow-hidden overflow-y-auto absolute h-" +
