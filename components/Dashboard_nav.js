...
const Dashboard_nav = ({ user, toggle, visible }) => {
  const router = useRouter();

  const [session, loading] = useSession();

  return (
    //         <div className='flex justify-between  w-screen bg-gradient-to-r from-indigo-700 to-indigo-800 z-20 h-16 shadow-md'>
    ...
    //              <line y1="29" x2="112" y2="29" stroke="white" strokeWidth="6" strokeDasharray="25 3"/>
    //              </svg>
    ...
    //                      <div className='px-3'>
    //                 {!session && (                <a href='#'  onClick={() => signIn()} className=' py-3 px-5 rounded-full bg-indigo-500 text-white hover:shadow-lg hover:bg-indigo-700 transition ease-out duration-400'>Sign in </a>
    //                             )    }
    //                 {session && (                <a href='#'  onClick={() => signOut()} className=' py-3 px-5 rounded-full bg-indigo-500 text-white hover:shadow-lg hover:bg-indigo-700 transition ease-out duration-400'>Sign Out </a>
    // ) }
    //             </div>
    //          </nav>
    //      </div>
    ...
    <div className={visible ? "w-0" : "  "}>
      <nav className="flex items-center bg-white shadow-md  p-3 w-screen flex-wrap">
        <span className="font-bold text-xl">Coin-Dash</span>
        <div onClick={toggle} className="flex cursor-pointer   ml-auto ">
          <div
            className={
              !visible
                ? "c-hamburger mr-2 c-hamburger--collapse active"
                : "c-hamburger mr-2 c-hamburger--collapse  "
            }
          >
      ...
      <div
        className={
          visible
            ? "top-nav w-full transform scale-0 transition   duration-150 ease-in-out origin-left "
            : "top-nav w-full  transform scale-100 transition duration-150 ease-in-out origin-left "
        }
      >
        <div className="flex flex-col w-full bg-white   ">
            ...
            <a
              className={
                router.asPath == "/dashboard"
                  ? " bg-indigo-500 px-3 py-2   font-semibold text-md hover:text-gray-100 hover:bg-indigo-500 text-gray-100"
                  : ' px-3 py-2   font-semibold text-md hover:text-gray-100 hover:bg-indigo-500 text-gray-700"'
              }
            >
          ...
          <Link href="#">
            <a
              className={
                router.asPath == "/dashboard/favorites"
                  ? " bg-indigo-500 px-3 py-2   font-semibold text-md hover:text-gray-100 hover:bg-indigo-500 text-gray-100"
                  : ' px-3 py-2   font-semibold text-md hover:text-gray-100 hover:bg-indigo-500 text-gray-700"'
              }
            >
          ...
          <Link href="#">
            <a
              className={
                router.asPath == "/dashboard/calculator"
                  ? " bg-indigo-500 px-3 py-2   font-semibold text-md hover:text-gray-100 hover:bg-indigo-500 text-gray-100"
                  : ' px-3 py-2   font-semibold text-md hover:text-gray-100 hover:bg-indigo-500 text-gray-700"'
              }
            >
          ...
          <Link href="#">
            <a
              className={
                router.asPath == "/dashboard/portfolio"
                  ? " bg-indigo-500 px-3 py-2   font-semibold text-md hover:text-gray-100 hover:bg-indigo-500 text-gray-100"
                  : ' px-3 py-2   font-semibold text-md hover:text-gray-100 hover:bg-indigo-500 text-gray-700"'
              }
            >
